...
for (const imgUrl of imgList) {
    ...
    const imgFileName = imgUrl.replace('https://media-cdn-zspms.kurogame.com/pnswebsite/website2.0/images/', '').replace('https://media-cdn-zspms.kurogame.net/pnswebsite/website2.0/images/', '').replace('/', '_')
